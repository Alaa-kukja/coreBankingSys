...
(function () {
    ...
    const localeOverride = window.localStorage.getItem('appLanguage');
    if (localeOverride) {
        // set dir attribute on <html> element.
        if (localeOverride === 'ar-SY') {
        ...
        requirejs.config({
            config: {
                ojL10n: {
                    ...
                    merge: {
                        'ojtranslations/nls/ojtranslations': 'resources/nls/sysInfoBankTranslations',
                    },
                },
            },
        });

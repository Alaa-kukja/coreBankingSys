define([
    ...
    function UnfreezeTermDepositViewModel(params) {
        const { router } = params;
        this.router = router;
    ...
    UnfreezeTermDepositViewModel.prototype._initAllObservable = function () {
        // 1
    ...
    UnfreezeTermDepositViewModel.prototype._initAllLabels = function () {
    ...
    UnfreezeTermDepositViewModel.prototype._initAllVariables = function () {
    ...
    UnfreezeTermDepositViewModel.prototype._initAllEvents = function () {
    ...
    UnfreezeTermDepositViewModel.prototype._initFetchData = function () {
        let tableCommand = {
            select: [],
    ...
    return UnfreezeTermDepositViewModel;
});

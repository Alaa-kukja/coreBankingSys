define([
    ...
    function freezeTermDepositViewModel(params) {
        const { router } = params;
        this.router = router;
    ...
    freezeTermDepositViewModel.prototype._initAllObservable = function () {
        // 1
    ...
    freezeTermDepositViewModel.prototype._initAllLabels = function () {
    ...
    freezeTermDepositViewModel.prototype._initAllVariables = function () {
    ...
    freezeTermDepositViewModel.prototype._initAllEvents = function () {
    ...
    freezeTermDepositViewModel.prototype._initFetchData = function () {
        let tableCommand = {
            select: [],
    ...
    return freezeTermDepositViewModel;
});
